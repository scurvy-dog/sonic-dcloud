...
sudo brctl addbr r1e64-host1
sudo brctl addbr r1e72-host2
...
sudo brctl addbr r2e64-host3
sudo brctl addbr r2e72-host4
...
sudo ip link set r1e64-host1 up
sudo ip link set r1e72-host2 up
...
sudo ip link set r2e64-host3 up
sudo ip link set r2e72-host4 up