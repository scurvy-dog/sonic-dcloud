...
" >> /home/cisco/util/boot-service.log
...
create endpoint bridges and routes" >> /home/cisco/util/boot-service.log
...
virsh start sonic VMs" >> /home/cisco/util/boot-service.log
